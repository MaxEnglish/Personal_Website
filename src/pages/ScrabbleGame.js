                                ...
                                if (valid) {
                                    ...
                                    for (const word of words) {
                                        ...
                                        if (!Array.isArray(data)) {
                                            valid = false;
                                            setInvalidWord({state: true, title: 'Invalid Word', text: `The word: ${word} does not exist in the dictionary. Please try again.`, onClick: ()=>setInvalidWord({state: false, title: '', text: '', onClick: null})});
                                        }
                                    })
                                    .catch(() => { 
                                        valid = false;
